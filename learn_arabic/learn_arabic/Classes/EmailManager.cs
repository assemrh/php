...
namespace learn_arabic.Classes
{
    ...
    {
        public async static Task<bool> SendEmail(string Title, string MailBody, string ToEMail, ER_Ref<string> errMessage, List<Attachment> lstAttFiles = null, string CCMail = "", string BCCMail = "") {
            ...
            try {
                ...
                string userState = "test message1";
                 SmtpServer.SendAsync(mail_message, userState);
